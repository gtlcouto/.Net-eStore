...
{
    public class eStoreConfigData
    {
        /// <sumary>
        /// Error routine for Exceptions that are thrown in the Data Objects
        /// Layer
        /// </sumary>
        ...
        public static void ErrorRoutine(Exception e, string obj, string method)
        {
            ...
            {
                log.WriteEntry("Error in eStoreDataObjects, object = " + obj + ", method = " + method + ", message = " + e.Message + " " + e.InnerException.Message, EventLogEntryType.Error);
                throw e.InnerException;
            }
            else
            {
                log.WriteEntry("Error in eStoreDataObjects, object = " + obj + ", method = " + method + ", message = " + e.Message, EventLogEntryType.Error);
                throw e;
            }
